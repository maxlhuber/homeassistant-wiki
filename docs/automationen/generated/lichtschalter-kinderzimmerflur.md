...
# Lichtschalter Kinderzimmerflur
...
Schaltet das Flurlicht bei linkem Tastendruck des Wandschalters im Kinderzimmerflur. Beim Einschalten wird tagsüber 100 Prozent und nachts zwischen Sonnenuntergang und Sonnenaufgang 30 Prozent Helligkeit gesetzt.

## Sie startet, wenn …

1. Eine Taste am Wandschalter Kinderzimmerflur wird gedrückt
...
??? info "Technik für Max"
    ...
    | Feld | Wert |
    |---|---|
    | Ursprünglicher Name | Lichtschalter Kinderzimmerflur |
    | Home-Assistant-ID | `1768304043154` |
    | Modus | `single` |
