...
1. Eine Taste am Wandschalter Büro wird gedrückt
...
1. Wenn büro ist „eingeschaltet“, dann büro ausschalten; andernfalls büro einschalten mit 100 % helligkeit
...
??? info "Technik für Max"
    ...
    | Feld | Wert |
    |---|---|
    | Ursprünglicher Name | Lichtschalter Büro |
