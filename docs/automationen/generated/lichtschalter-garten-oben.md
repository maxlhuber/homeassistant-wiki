...
1. Eine Taste am Wandschalter Garten wird gedrückt
...
1. Wenn terasse ist „eingeschaltet“, dann terasse ausschalten; andernfalls terasse einschalten mit 100 % helligkeit
...
??? info "Technik für Max"
    ...
    | Feld | Wert |
    |---|---|
    | Ursprünglicher Name | Lichtschalter Garten oben |
    | Home-Assistant-ID | 1768303832798 |
    | Modus | single |
    | Kategorie | Garten & Wasser |
    | Verwendete Entities | Terasse (`light.terasse`) |
