...
<div class="annotated-image">
  <img src="../assets/images/home-assistant/01-uebersicht-oben.png" alt="Home-Assistant-Übersicht auf dem iPhone">
  <span class="callout-marker" style="--x:50%;--y:8%" aria-label="Markierung 1">1</span>
  <span class="callout-marker" style="--x:25%;--y:55%" aria-label="Markierung 2">2</span>
  <span class="callout-marker" style="--x:74%;--y:55%" aria-label="Markierung 3">3</span>
</div>
